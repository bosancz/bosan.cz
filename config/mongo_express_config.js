...
module.exports = {
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || config.mongoExpress.username,
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || config.mongoExpress.password
  },
